                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link btn btn-danger" target="_blank" href="admin/pages_index.php">Login</a>
                        </li>
                    </ul>
            ...
            <div class="intro-content py-6 text-center">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-10 col-md-8 col-lg-12 mx-auto text-center">
                            <h1 class="my-3 display-8 d-none d-lg-inline-block"><?php echo $sys->sys_name; ?></h1>
                            <p class="lead mb-3">
                                <?php echo $sys->sys_tagline; ?>
                            </p>
                            <br>
                            <a class="btn btn-success btn-lg mr-lg-2 my-1" role="button">Login</a>
                        </div>
                    </div>
                </div>
            </div>
