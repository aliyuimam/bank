...
if (isset($_GET['deleteClient'])) {
  ...
  $adn = "DELETE FROM  iB_clients  WHERE client_number = ?";
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-success btn-sm" href="pages_view_client.php?client_number=<?php echo $row->client_number; ?>">
                           ...
                           <a class="btn btn-success btn-sm" href="update.php?client_number=<?php echo $row->client_number; ?>">
                            <i class="fas fa-cogs"></i>
                            Update
                          </a>
                          <a class="btn btn-danger btn-sm" href="pages_manage_clients.php?deleteClient=<?php echo $row->client_number; ?>">
